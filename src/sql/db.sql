...
CREATE TABLE `user` (
  ...
  `password` varchar(16) DEFAULT NULL COMMENT 'We can encrypt later if we want',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (email, firstName, lastName, password) VALUES('ad', 'Ansum', 'Dholakia', 'blahblah');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('ak47', 'AK', 'Kumar', 'qwerty');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('bgrif', 'Blake', 'Griffin', 'clippers');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('jimmyclackers', 'Jonathan', 'Lam', 'clackers');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('kgupta', 'KAPS', 'Gupta', 'word');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('kobeBryant', 'Kobe', 'Bryant', 'lakers');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('sechan', 'Sean', 'Chan', 'seanseanchan');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('sechen', 'Sean', 'Chen', 'seanseanchen');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('spark', 'Sean', 'Parker', 'seanseanparker');
INSERT INTO `user` (email, firstName, lastName, password) VALUES('vbhalodi', 'Viral', 'Bhalodia', 'password');
