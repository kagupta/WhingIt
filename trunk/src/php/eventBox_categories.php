...
<a href="#" action="attending.php" onclick="attending(<?php echo $id; ?>, <?php echo $attending; ?>)"> Attending </a> | 
<a href="#" action="attending.php" onclick="attending(<?php echo $id; ?>, <?php echo $notAttending; ?>)"> Not Attending </a>
