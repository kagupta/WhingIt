...
mysql_select_db("whingit", $link);
 ...
 $query1 = mysql_query("SELECT * FROM events WHERE id = 1");
 $data = mysql_fetch_array($query1);
 
 $query2 = mysql_query("SELECT * FROM description WHERE eventID = 1");
...
<td><textarea name="description" value = "<?php echo $data2['about']?>" cols="45" rows="6" id="description" class="bodytext"></textarea></td> 
</tr> 
<tr> 
